...
export default function Project({
	...
	return (
		<motion.div
			...
			<section className="bg-gray-100 max-w-[42rem] rounded-lg border border-black/5 overflow-hidden sm:pr-8 sm:h-[20rem] sm:group-even:pl-8 relative  hover:bg-gray-300 transition dark:bg-white/10 dark:hover:bg-white/20 dark:text-white">
				<div className="pt-4 pb-7 px-5 sm:pl-10 sm:pr-2 sm:pt-10 sm:max-w-[50%] flex flex-col h-full sm:group-even:ml-[18rem]">
					<h3 className=" text-gray-950 text-2xl font-semibold dark:text-white">{title}</h3>
