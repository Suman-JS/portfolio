  ...
  return (
    ...
    >
      ...
      >
        ...
        <span className="font-bold ml-2">front-end developer</span>, passionate
        about building <span className="italic">Webapps</span>. My expertise
        lies in
        <a className="hoverAnimation font-semibold dark:text-white ml-2">
          React (NEXT.js)
        </a>
        .
      </motion.h1>
      ...
      >
        ...
        <a
          ...
          target="_blank"
          href="https://www.linkedin.com/in/suman7mondal/"
        >
          <BsLinkedin />
        </a>
        <a
          ...
          rel="noopener noreferrer"
          target="_blank"
          href="https://github.com/Suman-JS"
        >
          <BsGithub />
        </a>
      </motion.div>
